...
func npmLocalBuild(ctx context.Context, req instrument.BuildRequest) instrument.Response {
...
func npmBuild(ctx context.Context, req instrument.BuildRequest) instrument.Response {
	if req.LocalBuild {
